...
namespace RBMAI.Patches
{
    ...
    public class GetSkillEffectsOnAgentPatch
    {
        public static bool Prefix(ref SandboxAgentStatCalculateModel __instance, ref Agent agent, 
    ...
    {
        public static void Postfix(ref Agent.UsageDirection __result, Formation formation, Agent unit, ArrangementOrderEnum orderEnum)
        {
    ...
    public class UpdateLastAttackAndHitTimesFix
    {

        public static bool Prefix(ref Agent __instance, Agent attackerAgent, bool isMissile)
        {
    ...
    public class OnTickAsAIPatch
    {

        public static Dictionary<Agent, float> itemPickupDistanceStorage = new Dictionary<Agent, float> { };

        public static void Postfix(ref SpawnedItemEntity ____itemToPickUp, ref Agent ___Agent)
        {
    ...
    [UsedImplicitly]
    [MBCallback]
    public class OverrideOnAgentShootMissile
    {

        //private static int _oldMissileSpeed;
        public static bool Prefix(Agent shooterAgent, EquipmentIndex weaponIndex, Vec3 position, ref Vec3 velocity, 
    ...
    public class OnAgentMountPatch
    {
        public static void Postfix(Agent agent)
        {
            if (!agent.IsPlayerControlled && agent.Formation != null && Mission.Current != null && Mission.Current.IsFieldBattle)
    ...
    public class ApplyActionOnEachUnitPatch
    {
        public static bool Prefix(ref Action<Agent> action, ref Formation __instance)
        {
            try
            {
    ...
    public class SetHighlightForAgentsPatch
    {
        public static bool Prefix(bool highlight, ref bool useSiegeMachineUsers, ref bool useAllTeamAgents, 
