...
namespace RBMAI.Patches
{
    ...
    public class TacticFullScaleAttackPatch
    {

        [HarmonyPostfix]
        [HarmonyPatch("Advance")]
        public static void PostfixAdvance(ref Formation ____mainInfantry, ref Formation ____archers, ref Formation ____rightCavalry, ref Formation ____leftCavalry, ref Formation ____rangedCavalry)
        {
        ...
        [HarmonyPostfix]
        [HarmonyPatch("Attack")]
        public static void PostfixAttack(ref Formation ____mainInfantry, ref Formation ____archers, ref Formation ____rightCavalry, ref Formation ____leftCavalry, ref Formation ____rangedCavalry)
        {
        ...
        public static void PostfixGetAiWeight(TacticFullScaleAttack __instance, ref float __result)
        {
