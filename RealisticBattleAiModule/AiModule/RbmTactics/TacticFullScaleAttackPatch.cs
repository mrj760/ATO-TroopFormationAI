    ...
    internal class TacticFullScaleAttackPatch
    {
            ...
            ref Formation ____rightCavalry, ref Formation ____leftCavalry, ref Formation ____rangedCavalry)
        {
            ...
            if (____rightCavalry != null)
            {
                ...
                ____rightCavalry.AI.SetBehaviorWeight<RBMBehaviorForwardSkirmish>(1f).FlankSide =
                    FormationAI.BehaviorSide.Right;
            }
            ...
            if (____leftCavalry != null)
            {
                ...
                ____leftCavalry.AI.SetBehaviorWeight<RBMBehaviorForwardSkirmish>(1f).FlankSide =
                    FormationAI.BehaviorSide.Left;
            }
        ...
        {
            var teamField =
                typeof(TacticFullScaleAttack).GetField("team", BindingFlags.NonPublic | BindingFlags.Instance);
            ...
            if (currentTeam.Side == BattleSideEnum.Defender)
                if (currentTeam.QuerySystem.InfantryRatio > 0.9f)
                    __result = 100f;
            if (float.IsNaN(__result)) __result = 0.01f;
        }
